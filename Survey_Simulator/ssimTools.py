...
def detWrite(fname, a, e, inc, r, mt, m_rand, h_rand, color, ic, flag, delta, m_int, h, eff, ra, dec, d_ra, d_dec, surna, comments):
    f_detect = open(fname, 'a')
    f_detect.write('%8.3f %6.3f %8.3f %8.3f %8.3f %8.3f %8.3f %6.2f %5.2f %2d %8.3f %8.3f %6.2f %4.2f %8.5f %8.4f %8.5f %8.5f %6s %s\n' % (a, e, inc/drad, a*(1.-e), r, mt/drad, m_rand, h_rand, color[ic-1], flag, delta, m_int, h, eff, ra/drad/15., dec/drad, d_ra/drad*3600./24., d_dec/drad*3600./24., surna, comments))
    f_detect.close()

def trackWrite(fname, a, e, inc, r, mt, m_rand, h_rand, color, ic,  comments):
    f_track = open(fname, 'a')
    f_track.write("%8.3f %6.3f %8.3f %8.3f %8.3f %8.3f %8.3f %6.2f %5.2f %s\n" % (a, e, inc/drad, a*(1.-e), r, mt/drad, m_rand, h_rand, color[ic-1], comments))
    f_track.close()
